    ...
    <div class="row align-items-center">
      ...
      <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
        <div class="ad-auth-content">
          <form method="get" action="lgServlet">
            ...
            <div class="ad-auth-form">
              <div class="ad-auth-feilds mb-30">
                <input type="text" placeholder="用户名" name="username" class="ad-input">
              ...
              <div class="ad-auth-feilds">
                <input type="password" placeholder="密码" name="password" class="ad-input">
                <div class="ad-auth-icon">
            ...
            <p class="ad-register-text">还没有账户？ <a href="register.jsp">点击注册</a></p>
          </form>
        </div>
      </div>
    </div>
